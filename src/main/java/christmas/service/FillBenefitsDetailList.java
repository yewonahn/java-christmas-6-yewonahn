...
public class FillBenefitsDetailList {
    public static void christmas(List<EachBenefitDetail> benefitDetails) {
        if(customerInputInfo.checkChristmas()) {
            int benefitPrice = CalculateBenefitAmount.dDay(customerInputInfo);
